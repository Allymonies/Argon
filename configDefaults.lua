return {
    ...
    theme = {
        colors = {
            ...
            activeItemBgColor = colors.lightBlue,
            searchBarColor = colors.black,
            searchBarBgColor = colors.white,
            searchBarPlaceholderColor = colors.lightGray,
            tabColor = colors.white,
            tabBgColor = colors.red,
            activeTabColor = colors.white,
            activeTabBgColor = colors.pink,
            modalColor = colors.black,
            modalBgColor = colors.white,
            modalButtonTextColor = colors.white,
            modalButtonBgColor = colors.blue,
            modalBorderColor = colors.lightGray,
            modalInputColor = colors.white,
            modalInputBgColor = colors.gray,
            modalInputPlaceholderColor = colors.lightGray,
            --

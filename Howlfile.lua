...
local SourceTask = Task:subclass("argon.SourceTask")
...
local MapTask = class("argon.MapTask")
...
Tasks:minify "minify" {
	input = "build/argon.lua",
	output = "build/argon.min.lua",
}

Tasks:require "main" {
	include = {"argon.lua", "schemas.lua", "configDefaults.lua", "constants.lua", "util/*.lua", "inventory/*.lua", "rules/*.lua", "conditions/*.lua", "components/*.lua", "modules/*.lua", "ui/*.lua"},
	startup = "argon.lua",
	output = "build/argon.lua",
}
